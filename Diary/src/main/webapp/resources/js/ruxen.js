$(function () {
	$(document).ready(function () {
		...
		/*---------- SEARCH FORM EFFECT ----------*/
		$(function () {
			$(document).on('click', '.header-search-form-button', function () {
				$('.header-search-form').addClass('header-search-form-active');
				$('.header-search-form-button').addClass('header-search-open');
				$('.header-search-form-button i').attr('class', 'fa fa-times');
			});

			$(document).on('click', '.header-search-open', function () {
				$('.header-search-form-button').removeClass('header-search-open');
				$('.header-search-form-button i').attr('class', 'fa fa-search');
		...
		if (fbroot == "") {
			...
			(function (d, s, id) {
				...
				js.id = id;
				js.src = "//connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v2.6&appId=244189802594837";
